...
class LlamaAttention(nn.Module):
    ...
    def forward(
        ...
        if attn_metadata.prefill_metadata!=None:
            ...
            decode_attn_event_list.append((start_attn_event,stop_attn_event))
...
class LlamaDecoderLayer(nn.Module):
    ...
    def forward(
        ...
        # Fully Connected
        start_mlp_event.record()
        hidden_states, residual = self.post_attention_layernorm(
            hidden_states, residual)
        hidden_states = self.mlp(hidden_states)
        stop_mlp_event.record()
        if attn_metadata.prefill_metadata!=None:
            prefill_mlp_event_list.append((start_mlp_event,stop_mlp_event))
        else:
            decode_mlp_event_list.append((start_mlp_event,stop_mlp_event))
